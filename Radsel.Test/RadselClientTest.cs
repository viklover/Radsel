...
using Radsel.Model;
using Radsel.Model.Battery;
using Radsel.Model.Event;
using Radsel.Model.Gate;
using Radsel.Process;
using static Radsel.Process.RadselClient;

namespace Radsel.Test;
/// <summary>
